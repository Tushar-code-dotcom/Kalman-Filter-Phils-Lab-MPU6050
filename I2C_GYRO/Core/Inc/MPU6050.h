...
#define MPU6050_REG_IMU_DATA_START 0x3B

/* Conversion constants (default settings: hcc +-2g, gyr +-250dps) */
#define MPU6050_ACC_RAW_TO_MPS2  0.00059875482f
#define MPU6050_GYR_RAW_TO_RPS   0.00013323124
#define MPU6050_TEMP_RAW_TO_DEGC 0.00294117647f
#define MPU6050_TEMP_DEGC_OFFSET 12412.0f
...
//protected:
       static uint8_t devAddr=208;
       static uint8_t buffer[14];
       static  uint32_t fifoTimeout = MPU6050_FIFO_DEFAULT_TIMEOUT;

       static float accelerationResolution;
       static float gyroscopeResolution;
...
typedef struct{
	...
	/* DMA receive buffer: [Ax_h Ax_1 Ay_h Ay_1 Az_h Az_1 Temp_h Temp_1 Gx_h Gx_1 Gy_h Gy_1 Gz_h Gz_1] */
	uint8_t rxData[14];

	/* Flag to indicate that data is being currently read by DMA */
